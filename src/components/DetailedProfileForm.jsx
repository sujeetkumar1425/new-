...
export function DetailedProfileForm({ user, onComplete, onSkip }) {
            ...
            {availableCertifications.map(cert => (
              <div key={cert} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleMultiSelectChange('certificationsPlanned', cert, checked)}
                />
            ...
            {courseInterests.map(course => (
              <div key={course} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleMultiSelectChange('coursesInterestedIn', course, checked)}
                />
